...
public class Activity1 extends AppCompatActivity {
    ...
    //actual images
    int image101, image201, image102, image202, image103, image104, image105, image106, image203, image204, image205, image206;
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        //check which image is selected and save it to a temporary variable
        if (cardNumber == 1) {
    ...
    private void calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            if (turn == 1) {
                playerPoints++;
                String value = getIntent().getStringExtra("key");
                tv_p1.setText(value + playerPoints);

            } else if (turn == 2) {
                cpuPoints++;
                tv_p2.setText("computer: " + cpuPoints);
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == View.INVISIBLE && iv_12.getVisibility() == View.INVISIBLE && iv_13.getVisibility() == View.INVISIBLE &&
                iv_14.getVisibility() == View.INVISIBLE && iv_21.getVisibility() == View.INVISIBLE && iv_22.getVisibility() == View.INVISIBLE &&
                iv_23.getVisibility() == View.INVISIBLE && iv_24.getVisibility() == View.INVISIBLE && iv_31.getVisibility() == View.INVISIBLE &&
                iv_32.getVisibility() == View.INVISIBLE && iv_33.getVisibility() == View.INVISIBLE && iv_34.getVisibility() == View.INVISIBLE) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Activity1.this);
            String value = getIntent().getStringExtra("key");
            alertDialogBuilder.setMessage("GAME OVERR!!\n " + value + ":" + playerPoints + "\n Computer :" + cpuPoints);
